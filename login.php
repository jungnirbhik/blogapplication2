...
Enter your email:<br>
      ...
      <input name="email" type="text" class="form-control" id="floatingInput" placeholder="email" required>
    ...
    Password:<br>
      ...
      <label for="floatingInput">password</label><br>
        ...
        <div class="my-2"required>Dont have an account? <a href="signup.php">Register here</a></div>
        
        <div class ="checkbox mb-3">
            <label><input name="remember" type ="checkbox" value="remember-me">Remember me</label>
        </div>
        
        <input class="btn btn-primary w-100 py-1" type ="submit" name ="login" value="login"><a href ="home.php">
